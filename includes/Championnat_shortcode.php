<?php
    ...
    function championnatFFT_resultats($atts) { 
        //le coté adlmin de wordpress est en erreur si je met $requetes et require si je ne les met pas l'appel a la base de données ne se fait pas 
        global $wpdb;
        $requetes = new Requetes($wpdb);
        
        //Se que l'on veut que la fonction fasse ici pour le test afficher "hello world"
        ...
        //on transforme le jsonen phrase
